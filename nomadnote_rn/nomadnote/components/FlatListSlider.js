...
import { normalize } from '../ui/login/Login';
...
export default class FlatListSlider extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            indicatorMargin: global.indicatorMarginTop,
        };
    ...
    render() {
        ...
        console.log('indicator: ', global.indicatorMarginTop)
        console.log('indicator screen: ', SCREEN_HEIGHT * 0.07)
                ...
                {this.props.indicator && (
                    <Indicator
                        ...
                        indicatorContainerStyle={[
                            ...
                            { marginTop: this.state.indicatorMargin }
                        ]}
